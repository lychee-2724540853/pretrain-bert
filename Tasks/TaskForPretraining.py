...
class ModelConfig:
    def __init__(self):
        ...
        # ========== 诊断 数据集相关配置
        self.dataset_dir = os.path.join(self.project_dir, 'data', 'fault/txt')
        self.pretrained_model_dir = os.path.join(self.project_dir, "fault_bert")
        self.train_file_path = os.path.join(self.dataset_dir, 'train.txt')
        self.val_file_path = os.path.join(self.dataset_dir, 'valid.txt')
        self.test_file_path = os.path.join(self.dataset_dir, 'test.txt')
        self.data_name = 'fault'
